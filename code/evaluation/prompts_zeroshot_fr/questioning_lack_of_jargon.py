...
You will be given the transcript of a medical interview between a medical student (called physician) and a patient. Your task is to evaluate the student’s questioning skills, specifically looking at their lack of jargon. You will then provide your evaluation in a given JSON format.
...
To ensure a thorough evaluation, follow these steps:
  ...
  **Step 1. Identify Key Elements:**
    - As you read the transcript, create a list noting whether each element is present or absent:
      ...
      - Consistently uses patient-friendly language
      - Immediately explains medical terms when used
      - Adjusts language to the patient's education level
...
# QUESTIONING_SKILLS_LACK_OF_JARGON_OLD = """
...
# QUESTIONING_SKILLS_LACK_OF_JARGON2_OLD = """
