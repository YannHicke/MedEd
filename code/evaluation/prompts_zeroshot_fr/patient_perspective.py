...
To ensure a thorough evaluation, follow these steps:
  ...
  **Step 1. Identify Key Elements:**
    - As you read the transcript, create a list noting whether each element is present or absent:
      - Elicits the patient’s feelings about the illness
      - Elicits the patient’s ideas of the cause of their illness
      - Elicits the impact of the illness on the patient’s daily function
      - Elicits the patient’s expectations for treatment and outcomes
      - Incorporates the patient’s perspective into the discussion
